...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            if (_context.Department.Any() || _context.Seller.Any() || _context.SalesRecords.Any())//Pergunta o banco de dados já foi populado?
            {
                return; //O banco de dados já foi populado.
            }

            //Povoando meu banco de dados:
            ...
            //"AddRange"Adiciona todos os objeto de uma só vez no banco de dados e assim povoando ele:
